...
It receives a [Point](https://nut-tree.github.io/nut.js/classes/point.html) which specifies the expected [mouse](https://nut-tree.github.io/nut.js/classes/mouse.html) cursor position on screen.
...
`toShow` receives a filename of an image in our [resourceDirectory](https://nut-tree.github.io/nut.js/classes/screen.html#config) and checks whether it's visible on our screen or not.
